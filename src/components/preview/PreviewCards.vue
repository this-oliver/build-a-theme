...
const ContentTitle = 'Cards';
const ContentDescription = 'Cards are used to display content related to a single subject. Try toggling the options below to see how they affect the cards.';
